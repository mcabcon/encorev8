...
"Summary: Returns a new array of <array> with <ent> added to it."
"Module: Array"
"CallOn: "
"MandatoryArg: <array> The array to add <ent> to."
"MandatoryArg: <ent> The entity (or anything) to add to <array>."
...
{
	clientscripts\_callbacks::AddCallback("playerspawned", func);
}
