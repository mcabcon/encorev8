...
#/
	...
	// ALEXP_MOD: 6/17/09 feature test: kill slow mo (this will need to be done properly if we keep it)
...
// Special death is for corners, rambo behavior, mg42's, anything out of the ordinary stand and crouch.  
...
do_gib()
{
	...
	{
/#
		println( "^3animscripts\zombie_death.gsc - limb_data is not setup for gib_ref on model: " + self.model + " and gib_ref of: " + self.a.gib_ref ); 
#/
